...
urlpatterns=[
    ...
    url(r'^addQuestion/(?P<test_name>.+)/(?P<test_counter>.+)', Add_question.as_view()),
    ...
    url(r'^Manage\squestion/(?P<test_name>.+)/(?P<test_counter>.+)', Manage_question.as_view()),
    ...
    url(r'^Online\sTesting\sFree\sQuiz\sMaker\sCreate\sthe\sBest\sweb-based\squizzes\sClassMarker',
        Online_Testing_Free_Quiz_Maker_Create_the_Best_web_based_quizzes_ClassMarker.as_view()),
    ...
    url(r'^Quiz\smaker\s-\sStep\sby\sStep\sInstructions\sClassMarker',
        Quiz_maker_Step_by_Step_Instructions_ClassMarker.as_view()),
    ...
    Web_based_online_testing_service_Free_quiz_maker_ClassMarker.as_view()),
